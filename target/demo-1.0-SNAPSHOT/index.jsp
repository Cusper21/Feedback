...
<form action="SaveServlet" method="post">
    ...
    <div>
        ...
        <input type="checkbox" id="students" name="rChecked" value="students"><br><br>

        <label for="location">location</label>
        <input type="checkbox" id="location" name="rChecked" value="location"><br><br>

        <label for="campus">campus</label>
        <input type="checkbox" id="campus" name="rChecked" value="campus"><br><br>

        <label for="atmosphere">atmosphere</label>
        <input type="checkbox" id="atmosphere" name="rChecked" value="atmosphere"><br><br>

        <label for="sports">sports</label>
        <input type="checkbox" id="sports" name="rChecked" value="sports"><br><br>
    </div>
